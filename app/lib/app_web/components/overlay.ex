defmodule AppWeb.Components.Overlay do
  @moduledoc """
  The `AppWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `AppWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
