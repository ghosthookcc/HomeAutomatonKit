defmodule AppWeb.Components.Stepper do
  @moduledoc """
  The `AppWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `AppWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
