defmodule AppWeb.Components.Spinner do
  @moduledoc """
  The `AppWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `AppWeb.Components.Spinner` module enables developers to provide
