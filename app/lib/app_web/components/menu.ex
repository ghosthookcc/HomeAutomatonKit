defmodule AppWeb.Components.Menu do
  @moduledoc """
  The `AppWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `AppWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import AppWeb.Components.Accordion, only: [accordion: 1]
  import AppWeb.Components.Button, only: [button_link: 1]
