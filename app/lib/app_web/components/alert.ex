defmodule AppWeb.Components.Alert do
  @moduledoc """
  AppWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
