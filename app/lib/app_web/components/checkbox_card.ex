defmodule AppWeb.Components.CheckboxCard do
  @moduledoc """
  The `AppWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
