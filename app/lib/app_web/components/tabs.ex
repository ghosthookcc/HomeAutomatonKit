defmodule AppWeb.Components.Tabs do
  @moduledoc """
  `AppWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import AppWeb.Components.Badge, only: [badge: 1]
