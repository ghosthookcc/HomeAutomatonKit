defmodule AppWeb.Components.Divider do
  @moduledoc """
  The `AppWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `AppWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
