defmodule BackupPluginWeb.Components.Image do
  @moduledoc """
  The `BackupPluginWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
