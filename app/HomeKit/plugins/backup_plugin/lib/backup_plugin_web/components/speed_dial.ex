defmodule BackupPluginWeb.Components.SpeedDial do
  @moduledoc """
  The `BackupPluginWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
