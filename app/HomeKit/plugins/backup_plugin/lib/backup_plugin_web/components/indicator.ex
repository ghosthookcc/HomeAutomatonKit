defmodule BackupPluginWeb.Components.Indicator do
  @moduledoc """
  The `BackupPluginWeb.Components.Indicator` module provides a versatile component for visually highlighting
