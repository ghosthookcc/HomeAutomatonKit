defmodule BackupPluginWeb.Components.Banner do
  @moduledoc """
  BackupPluginWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
