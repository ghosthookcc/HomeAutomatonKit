defmodule BackupPluginWeb.Components.Stepper do
  @moduledoc """
  The `BackupPluginWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `BackupPluginWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
