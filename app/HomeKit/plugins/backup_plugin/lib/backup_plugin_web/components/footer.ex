defmodule BackupPluginWeb.Components.Footer do
  @moduledoc """
  The `BackupPluginWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
