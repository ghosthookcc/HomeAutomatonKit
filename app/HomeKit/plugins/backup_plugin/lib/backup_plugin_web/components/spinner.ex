defmodule BackupPluginWeb.Components.Spinner do
  @moduledoc """
  The `BackupPluginWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `BackupPluginWeb.Components.Spinner` module enables developers to provide
