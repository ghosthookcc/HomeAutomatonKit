defmodule BackupPluginWeb.Components.MegaMenu do
  @moduledoc """
  The `BackupPluginWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
