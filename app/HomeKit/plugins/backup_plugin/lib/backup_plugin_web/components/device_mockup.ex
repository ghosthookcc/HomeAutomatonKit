defmodule BackupPluginWeb.Components.DeviceMockup do
  @moduledoc """
  The `BackupPluginWeb.Components.DeviceMockup` module provides a customizable component for displaying
