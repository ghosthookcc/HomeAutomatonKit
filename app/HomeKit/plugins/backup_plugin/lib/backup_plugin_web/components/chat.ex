defmodule BackupPluginWeb.Components.Chat do
  @moduledoc """
  `BackupPluginWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
