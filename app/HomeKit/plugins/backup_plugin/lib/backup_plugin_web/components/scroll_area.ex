defmodule BackupPluginWeb.Components.ScrollArea do
  @moduledoc """
  The `BackupPluginWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
