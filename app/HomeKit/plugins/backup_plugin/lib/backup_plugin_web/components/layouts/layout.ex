defmodule BackupPluginWeb.Components.Layout do
  @moduledoc """
  The `BackupPluginWeb.Components.Layout` module provides powerful and customizable layout components
  ...
  - **Fully Configurable Props:** Customize direction, alignment, spacing, order, wrBackupPlugining,
  ...
  attr :wrap, :string,
    default: "wrap",
    doc: "Controls wrBackupPlugining behavior of flex items"
  ...
  attr :class, :string,
    default: "",
    doc: "Additional CSS classes to BackupPluginly to the container"
