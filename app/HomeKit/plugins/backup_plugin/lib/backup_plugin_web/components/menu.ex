defmodule BackupPluginWeb.Components.Menu do
  @moduledoc """
  The `BackupPluginWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `BackupPluginWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import BackupPluginWeb.Components.Button, only: [button_link: 1]
