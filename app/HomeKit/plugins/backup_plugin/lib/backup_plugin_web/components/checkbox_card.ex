defmodule BackupPluginWeb.Components.CheckboxCard do
  @moduledoc """
  The `BackupPluginWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
