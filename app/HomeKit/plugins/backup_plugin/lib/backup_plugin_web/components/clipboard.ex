defmodule BackupPluginWeb.Components.Clipboard do
  @moduledoc """
  The `BackupPluginWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
