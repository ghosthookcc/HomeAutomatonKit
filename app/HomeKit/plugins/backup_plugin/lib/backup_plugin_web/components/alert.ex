defmodule BackupPluginWeb.Components.Alert do
  @moduledoc """
  BackupPluginWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
