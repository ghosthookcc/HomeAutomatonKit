defmodule BackupPluginWeb.Components.FileField do
  @moduledoc """
  The `BackupPluginWeb.Components.FileField` module provides a versatile and customizable component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/file-field
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BackupPluginWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BackupPluginWeb.Gettext, "errors", msg, opts)
    end
  end
end
