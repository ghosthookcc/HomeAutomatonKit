defmodule BackupPluginWeb.Components.Overlay do
  @moduledoc """
  The `BackupPluginWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `BackupPluginWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
