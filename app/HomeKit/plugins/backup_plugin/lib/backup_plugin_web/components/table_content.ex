defmodule BackupPluginWeb.Components.TableContent do
  @moduledoc """
  `BackupPluginWeb.Components.TableContent` is a component module designed to create flexible and dynamic
